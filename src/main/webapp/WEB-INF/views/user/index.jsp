			...
			<div class="row features-inner">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img
								src="<c:url value='/assets/user/img/features/f-icon1.png' />"
								alt="">
						</div>
						<h6>Free Delivery</h6>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img
								src="<c:url value='/assets/user/img/features/f-icon2.png' />"
								alt="">
						</div>
						<h6>Return Policy</h6>
						<p>Free Shipping on all order</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img
								src="<c:url value='/assets/user/img/features/f-icon3.png' />"
								alt="">
						</div>
						<h6>24/7 Support</h6>
						<p>Free Shipping on all order</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img
								src="<c:url value='/assets/user/img/features/f-icon4.png' />"
								alt="">
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								<div class="overlay"></div>
								<img class="img-fluid w-100"
									src="<c:url value='/assets/user/img/category/c2.jpg ' />"
									alt=""> <a
									href="<c:url value='/assets/user/img/category/c2.jpg' />"
									class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Sneaker for Sports</h6>
									</div>
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<a href="<c:url value='/assets/user/img/category/c3.jpg ' />"
									class="img-pop-up" target="_blank">
									<div class="deal-details">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p1.jpg' />" alt="">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p2.jpg' />" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole for Sports person</h6>
								<div class="price">
									<h6>$150.00</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p3.jpg' />" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole for Sports person</h6>
								<div class="price">
									<h6>$150.00</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p4.jpg' />" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole for Sports person</h6>
								<div class="price">
									<h6>$150.00</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p5.jpg' />" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole for Sports person</h6>
								<div class="price">
									<h6>$150.00</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p6.jpg' />" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole for Sports person</h6>
								<div class="price">
									<h6>$150.00</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid"
								src="<c:url value='/assets/user/img/product/p7.jpg' />" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole for Sports person</h6>
								<div class="price">
									<h6>$150.00</h6>
